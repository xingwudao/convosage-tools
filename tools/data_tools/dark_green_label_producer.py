...
# 配置参数
OUTPUT_IMAGE_DIR = "dataset/dark_green_images"
OUTPUT_LABEL_DIR = "dataset/dark_green_labels"
# 随机选择常见手机屏幕尺寸
IMAGE_SIZE = random.choice([(450, 800), (480, 854), (540, 960)])  
# 添加绿色气泡类别
CLASSES = {"dark_bubble": 0, "others": 1, "green_bubble": 2}  
# 生成转账卡片的概率
TRANSFER_PROB = 0.05
...
def generate_realistic_chat(image_index):
    """生成一张逼真微信聊天截图并返回标注数据"""
    # 创建背景
    bg_images_dir = "dataset/background"
    bg_images = [os.path.join(bg_images_dir, f) for f in os.listdir(bg_images_dir) if f.endswith(('.jpg', '.png'))]
    if not bg_images:
        raise FileNotFoundError("No background images found in the 'background' folder.")
    ...
    if random.random() < 0.5:
        ...
        draw.rectangle([0, 0, IMAGE_SIZE[0], status_bar_height], fill=(60, 60, 60))
        draw.text((225, 10), "微信", fill=(255, 255, 255), font=ImageFont.truetype("simhei.ttf", 18))
        draw.text((20, 20), f"{random.randint(10, 12)}:{random.randint(10, 59):02d}",
                  fill=(255, 255, 255), anchor="mm", font=ImageFont.truetype("arial.ttf", 18))
    ...
    for _ in range(random.randint(6, 12)):
        ...
        if random.random() < TRANSFER_PROB:
            ...
            draw.text((txt_x, txt_y), card_text, fill=border_color, font=font_t)
            # 标注转账卡片
            # 计算并归一化卡片标注坐标
        ...
        messages = ["你好！", "对对对好玩好玩太棒了好有",
                    ...
                    "收到请回复", "资料已发", "谢谢！",
                    "哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈",
                    "不喜欢潮湿闷热的天气，舒适感很低，是的，我也觉得很闷热，但是我喜欢这种感觉，我喜欢这种感觉，我喜欢这种感觉，我喜欢这种感觉，我喜欢这种感觉，我喜欢这种感觉，我喜欢这种感觉，我喜欢这种感觉，我喜欢这种感觉，我喜欢这种感觉，我喜欢这种感觉，我喜欢这种感觉，我喜欢这种感觉，我喜欢这种感觉，我喜欢这种感觉，我喜欢这种感觉，我喜欢这种感觉，我喜欢这种感觉，我喜欢这种感觉，我喜欢这种感觉，我喜欢这种感觉，我喜欢这种感觉，我", "我喜欢晴天",
                    "嗯，好的","我觉得你说得对",
                    "我也这么认为","我同意你的观点",
        ...
        # 绘制气泡（圆角矩形）
        # 只标注对方气泡，绿色气泡（自己气泡）不做标注
        bubble_color = (54, 54, 54) if not is_sender else (156, 231, 97)
        ...
        text_color = (255, 255, 255) if not is_sender else (0, 0, 0)
        ...
        if last_y > IMAGE_SIZE[1] - 100:  # 预留底部空间
            break    
    # 保存图片
    img_path = os.path.join(OUTPUT_IMAGE_DIR, f"dark_image_{image_index:03d}.jpg")
    img.save(img_path, format="JPEG")
    
    # 保存标注
    label_path = os.path.join(OUTPUT_LABEL_DIR, f"dark_image_{image_index:03d}.txt")
